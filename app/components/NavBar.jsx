...
const NavBar = () => {
    return (
        ...
        <nav className='p-3 bg-blue-300 rounded border-blue-400 dark:bg-blue-600 dark:border-blue-700 ' role='navigation'>
            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <ul className="flex flex-col mt-4 bg-blue-300 border-blue-400 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-blue-400 md:dark:bg-transparent dark:border-blue-700 ">
                    <li >
                        <Link href="/" className="block py-2 pr-4 pl-3 text-white bg-white-700 rounded md:bg-transparent md:text-white-700 md:p-0 md:dark:text-white dark:bg-white-600 md:dark:bg-transparent" >Home </Link>
                    </li>
                    <li>
