...
const NavBar = () => {
    return (       
        <nav className='p-3 bg-[#007178]   border-blue-400  dark:border-gray-600 dark:bg-gray-700  '>            
            <div className="container flex flex-wrap w-screen  items-center text-center justify-between  ">
                ...
                <ul className="flex flex-col mt-4  ml-10% text-center  justify-center items-center  border-blue-400 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:dark md:dark:bg-transparent ">
