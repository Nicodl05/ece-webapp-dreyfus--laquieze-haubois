...
const NavBar = () => {
    return (
        <nav className='p-3 bg-red-100 rounded border-blue-200 dark:bg-blue-400 dark:border-blue-700 ' role='navigation'>
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <ul className="flex flex-col mt-4 bg-blue-50 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-blue-400 md:dark:bg-transparent dark:border-blue-700 ">
